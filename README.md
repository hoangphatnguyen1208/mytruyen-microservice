...
| `catalog-service` | Java 17 / Spring Boot | Books, authors, taxonomy, chapters and chapter content | JPA/Flyway + JWT-protected book/taxonomy APIs; chapter workflows next |
