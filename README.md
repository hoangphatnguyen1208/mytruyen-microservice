...
| `catalog-service` | Java 17 / Spring Boot | Books, authors, taxonomy, chapters and chapter content | Book/taxonomy APIs + draft chapter/content CRUD; publication workflows next |
